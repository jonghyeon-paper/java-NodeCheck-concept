...
public class SubProgramNode extends Node {
	...
	public SubProgramNode(NodeContext context) {
		this.parse(context);
	}
		...
		*/
		...
		while (true) {
			if (context.currentToken() == null) {
				throw new NodeContextException("Missing keyword 'EndSub'");
			} else if (ProgramNodeType.END_SUB.getProgramName().equals(context.currentToken())) {
				// Sub program exit
				/*
